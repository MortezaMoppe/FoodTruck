import { useReceipt} from "../data/receiptData";

export const Receipt = () => {
  const { order, cart, totalPrice, moms, handleNewOrder, navigate } = useReceipt();
      ...
      <div className="bg-gray-300 text-gray-900 p-4 rounded-lg shadow-md w-full max-w-md">
        ...
        {cart.map((item) => (
          <div key={item.id} className="flex justify-between items-center relative">
            ...
            <span className="flex-grow mx-2 relative 
              ...
              before:text-gray-400 before:overflow-hidden before:whitespace-nowrap before:pointer-events-none">
            </span>
        ...
        <div className="flex justify-between items-start w-full pt-2 mt-2">
          <div className="text-left">
            ...
            <p className="text-sm text-gray-500">moms: 20% {moms.toFixed(2)} kr</p>
          </div>
